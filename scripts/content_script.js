...
const checks = [
    ...
    {
        "excerpt": "Some 108 arrests were made at Emerson College, Boston police told the BBC's US partner CBS News.",
        "label": "PARTIAL",
        ...
        if (response.html) {
            ...
            if (isFromNewsSource || response.html.includes("<article>") || response.html.includes("\"article:tag\"")) {
                ...
                for (let i = 0; i < checks.length; i++) {
                    ...
                    if (check.label === "TRUE") {
                        highlightText(check.excerpt, "#92d4b7");
                    }
                    else if (check.label === "FALSE") {
                        highlightText(check.excerpt, "#D66853");
                    }
                    else if (check.label === "PARTIAL") {
                        highlightText(check.excerpt, "#F09D51");
                    }
                }
            }
        } else {
